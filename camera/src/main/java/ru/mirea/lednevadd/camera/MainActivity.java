package ru.mirea.lednevadd.camera;
...
import ru.mirea.lednevadd.camera.databinding.ActivityMainBinding;
...
public	class	MainActivity	extends	AppCompatActivity implements ActivityResultCallback<ActivityResult>{
    ...
    public void OnUpdatePhoto(View v) {
        ...
        try {
            ...
            String authorities = "ru.mirea.lednevadd.camera.fileprovider";
